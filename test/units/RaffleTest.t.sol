...
contract RaffleTest is Test {
    ...
    modifier enteredRaffleAndTimeHasPassed() {
        vm.prank(PLAYER);
    ...
    ) public enteredRaffleAndTimeHasPassed skipFork{
        // Arrange
        // Act / Assert
        ...
        skipFork
    {
        ...
        assert(lengthOfPlayers == 0);
        assert(startingTimeStamp < block.timestamp);
    }
}
